...
//function prototype wiith name get_letter_grade_using_if that accepts int grade
std::string get_letter_grade_using_if(int grade);

//function prototype with name get_letter_grade_using_swtch that accepts int grade
